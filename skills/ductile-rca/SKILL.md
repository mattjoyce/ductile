...
| Gateway refuses to start after config edit | High-tier integrity mismatch (`webhooks.yaml`, `scopes/*.json`) | startup log: "checksum mismatch" | Lock tier is *hard fail* for high-security, *warn* for operational. |
