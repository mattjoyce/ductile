...
func TestValidate(t *testing.T) {
	tests := []struct {
		...
		{
			name: "negative telemetry.stopwatch.retention_days",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{RetentionDays: -1},
				},
			},
			wantErr: true,
		},
		{
			name: "negative telemetry.stopwatch.rollup.retention_days",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{
						Rollup: StopwatchRollupConfig{RetentionDays: -1},
					},
				},
			},
			wantErr: true,
		...
		{
			name: "negative telemetry.stopwatch.janitor.interval",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{
						Janitor: StopwatchJanitorConfig{Interval: -1 * time.Second},
					},
				},
			},
			wantErr: true,
		...
		{
			name: "negative telemetry.stopwatch.janitor.batch_size",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{
						Janitor: StopwatchJanitorConfig{BatchSize: -1},
					},
				},
			},
			wantErr: true,
		...
		{
			name: "zero telemetry values are accepted as use-default",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{
						RetentionDays: 0,
						Rollup:        StopwatchRollupConfig{Enabled: true, RetentionDays: 0},
						Janitor:       StopwatchJanitorConfig{Interval: 0, BatchSize: 0},
					},
				},
			},
			wantErr: false,
		...
		{
			name: "populated telemetry config is accepted",
			cfg: &Config{
				Service:     ServiceConfig{TickInterval: 60 * time.Second, LogLevel: "info", MaxWorkers: 1},
				State:       StateConfig{Path: "./test.db"},
				PluginRoots: []string{"./plugins"},
				Telemetry: TelemetryConfig{
					Stopwatch: StopwatchTelemetryConfig{
						RetentionDays: 14,
						Rollup:        StopwatchRollupConfig{Enabled: true, RetentionDays: 365},
						Janitor:       StopwatchJanitorConfig{Interval: 1 * time.Hour, BatchSize: 5000},
					},
				},
			},
			wantErr: false,
