...
func sqliteColumnExists(ctx context.Context, db *sql.DB, table, column string) (bool, error) {
	// SECURITY: Use table-valued function pragma_table_info(?) instead of string interpolation
	// to prevent SQL injection vulnerabilities from unvalidated table names.
